package com.example.voice_rsa.core.recog;
...
import com.example.voice_rsa.core.util.MyLogger;
...
//        InputStream inputStream =  InFileStream.create16kStream();
//        try {
//            asr.send(SpeechConstant.ASR_START,null,inputStreamToByteArray(inputStream),0,0);
//        }catch (Exception e){
//            e.printStackTrace();
//        }
